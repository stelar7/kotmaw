...
fun KotMaw.summonerByName(platform: Platform, name: String) = async {
    get(APIEndpoint.SUMMONER_BY_NAME, hashMapOf("platform" to platform, "name" to name)) as Summoner
}

fun KotMaw.summonerBySummonerId(platform: Platform, id: Long) = async {
    get(APIEndpoint.SUMMONER_BY_ID, hashMapOf("platform" to platform, "id" to id)) as Summoner
}

fun KotMaw.summonerByAccountId(platform: Platform, id: Long) = async {
